...
function () {
    ...
    document.querySelectorAll('.tooltip-demo').forEach(function (a) {
        ...
        b.show()
    }), f = document.getElementById('liveToastBtn'), g = document.getElementById('liveToast'), f && f.addEventListener('click', function () {
        var a = new bootstrap.Toast(g);
        a.show()
    }), i = document.getElementById('liveAlertPlaceholder'), e = document.getElementById('liveAlertBtn');

    function j(b, c) {
        var a = document.createElement('div');
        a.innerHTML = '<div class="alert alert-' + c + ' alert-dismissible" role="alert">' + b + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>', i.append(a)
    }
    e && e.addEventListener('click', function () {
        j('Nice, you triggered this alert message!', 'success')
    ...
    }), h = '<div class="bd-clipboard"><button type="button" class="btn-clipboard" title="Copy to clipboard">Copy</button></div>', document.querySelectorAll('div.highlight').forEach(function (a) {
    ...
    }), d = new ClipboardJS('.btn-clipboard', {
        target: function (a) {
